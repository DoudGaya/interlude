...
export const Banner = () => {
    return (
        <div className="flex items-center bg-white dark:bg-gray-950 justify-center min-h-screen space-y-3 flex-col w-full">
        ...
        <h3 className=" font-logo text-3xl dark:text-indigo-50 text-purple-950 ">Your productivity friend.</h3>
