export const Timer = () => {
    return (
        ...
        <div className=" rounded-xl  px-4 py-3 space-y-4  justify-center w-full flex flex-col border border-gray-300">
            <div className=" flex items-baseline ">
                <div className=" font-bold text-2xl font-primary text-gray-950 dark:text-gray-200">02:00:00</div>
                <span className="  rounded-lg px-1 text-secondary ">work</span>
            </div>
